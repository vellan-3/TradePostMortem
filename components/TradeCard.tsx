        ...
        <div className="ds-tc-exp ds-fade-in">
          ...
          <div className="ds-tc-actions">
            ...
            <div className="ds-tc-actions-right">
              <button className="ds-btn-tertiary" onClick={() => window.open(`https://twitter.com/intent/tweet?text=Check out my SLIP report!`, '_blank')}>𝕏 POST</button>
              <button className="ds-btn-tertiary">SHARE PAYSLIP</button>
            </div>
          </div>
        </div>
      )}
